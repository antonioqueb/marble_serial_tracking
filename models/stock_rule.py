...
class StockRule(models.Model):
    ...
    def _get_stock_move_values(self, product_id, product_uom, location_id, name,
        ...
        """
        res = super()._get_stock_move_values(product_id, product_uom, location_id, 
                                             name, origin, company_id, values)
        # Copiamos tus campos personalizados:
        res.update({
